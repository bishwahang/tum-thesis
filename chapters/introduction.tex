...
The study of aforementioned behavioral interference between malware families will provide novel knowledge for understanding the dynamic aspect of modern malware and the inter-family relations.
...
The candidate pairs are then run in malware analysis system, and the results are further analyzed to detect if there was any behavioral interference between the malware samples.
