...
Then, we describe the specifications of Anubis system and the results of candidate pair run in~\autoref{sec:Results}.
We discuss the effectiveness of our approach in~\autoref{sec:Effectiveness} and also elaborate the threats to validity of our approach in~\autoref{sec:Threats to Validity}.
