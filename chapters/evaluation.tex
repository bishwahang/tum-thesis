...
The malware variants of \emph{Gen:Trojan.Heur.buW@Ijs6jxj} creates the file \emph{C:\textbackslash windows\textbackslash system32\textbackslash svrchost.exe} with its run. % chktex-file 1
