...
The malware of type \emph{Trojan-Spy.Win32.KeyLogger} creates the file \emph{C:\textbackslash windows\textbackslash system32\textbackslash svrchost.exe} when it was run. % chktex-file 1
