...
% We could have increased the quality of candidate pair selection if we had filter out malware pair with with such randomly generated corresponding resource name.
