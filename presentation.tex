...
\begin{columns}
  \begin{column}{5cm}
    \begin{figure}[t]
      \centering
      \includegraphics[scale=0.17]{figures/malware_type.png}
      \label{fig:malware_type}
    \end{figure}
\begin{itemize}
  % \item Different variants of same malware
  \item Hard to detect with signature based
  \item Static and dynamic analysis (Anubis)
\end{itemize}
  \end{column}
  \begin{column}{5cm}
    \begin{figure}[t]
      \begin{center}
        \includegraphics[scale=0.15]{figures/malware_all.png}
      \end{center}
    \end{figure}
  % \begin{center}
...
%   \item Hard to detect with signature based
%   \item Static and dynamic analysis (Anubis)
%   \item Driven by monetary profit
%   \item In 2006, 2.8 billion dollars in US and 9.3 billion euros in Europe
% \end{itemize}
\end{frame}
...
% \subsection{Results}
% \label{sub:Results}
% \begin{frame}[h]{Result of Candidate Run}
