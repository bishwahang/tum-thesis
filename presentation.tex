...
\begin{itemize}
    ...
    \item It can be classified into self-replicating (virus,worms) and non-replicating (Trojan)
    \item Based on its ability to change its structure it can also be broadly classified into Polymorphic and Metamorphic
    \item Different variants of same malware with similar semantics or same author are regarded as to be from same family
\end{itemize}
\end{frame}
